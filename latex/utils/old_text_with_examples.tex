...
\todo[m]{Using AI just make some summary of the chapter here}
...
\todo[h]{Create here introduction to your thesis (motivation) - you can ask AI to figure out the structure for your introduction - what can you mention}
...
\todo[h]{Write here a goal - what are the goals of your thesis, basically just copy and paste from your projects web, and add more specifics}
...
\todo[h]{Update items here - they should be updated to your projects. Now it is different - as in the first version of your thesis}
\begin{itemize}
  \item Understand the previous research.
  \item Research new current state-of-the-art techniques.
  \item Clearly differentiate between adopted methods and original innovations.
  \item If needed, add additional, more complex data sources.
  \item Implement advanced and specialized models (BERT, GPT, or other transformer networks).
  \item Focus on the interpretability of the models (e.g., using SHAP or LIME).
  \item Present experimental results clearly and compare them with previous work.
\end{itemize}
