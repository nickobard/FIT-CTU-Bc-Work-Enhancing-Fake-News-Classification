...
class Transformer(Model):
    ...
    def __init__(self,
        ...
        self.name = name
        self.transformers_identifier = transformers_identifier
    ...
    def init(self, logger=None, random_state=None):
        ...
        log_params({'model_name': self.name,
                    'transformers_identifier': self.transformers_identifier,
                    'model_signature': self.assemble_signature()}, self.logger)
    ...
    def fit(self, dataset):
        ...
        training_args = TrainingArguments(
            optim=self.training_args['optimizer'],
            lr_scheduler_type=self.training_args['lr_scheduler'],
